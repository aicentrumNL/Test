  ...
  return (
    <svg className={className} width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
      ...
      <path d="M7 27c4-1 7-3 9-6 2.4-3.6 5-6.4 9-7.5 3-0.8 6-0.6 8 0.5"
            stroke="var(--accent-soft)" strokeWidth="1.3" strokeLinecap="round" opacity="0.85" />
      <path d="M9 31c5-1 9-3.5 11.5-7 2.6-3.7 5.4-6 9.5-7"
            stroke="rgba(241,236,226,0.45)" strokeWidth="1" strokeLinecap="round" />
      <text x="20" y="19.5" textAnchor="middle" fontFamily="Fraunces, Georgia, serif"
            fontSize="13.5" fill="var(--ink-paper)" letterSpacing="0.5">GG</text>
    </svg>
  )
}
